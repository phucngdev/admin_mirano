...
const DetailAcc: React.FC<FormProps> = ({ onFormChange }) => {
    const [formData, setFormData] = useState({
        ...
        email: "",
        address: "",
        accountType: "Chọn trường của bạn",
        speciaLized: "Chọn chuyên ngành của bạn",
    });
            ...
            <div style={{ marginBottom: '10px' }}>
                ...
                <div>
                    <Select
                        ...
                        defaultValue="Chọn trường của bạn"
                        style={{ width: "100%" }}
                        options={[
                            { value: 'sv', label: 'sv' },
                            { value: 'gv', label: 'gv' },
